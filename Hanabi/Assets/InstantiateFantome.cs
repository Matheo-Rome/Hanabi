...
public class InstantiateFantome : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        ) //j'instancie le fantome la première fois que je suis à 200, le booléen me permet de ne pas instancier 36 fantome toutes les secondes mais uniquement la première fois que je passe à 200
        {
        ...
        ) // cette méthode me permet de détruire l'instance du fantome créé lorsque notre stress passe en dessous de 189
        {
            Oneinstance = false;
