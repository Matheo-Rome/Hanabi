...
public class InstantiateSolo : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (P2 == 1)
            Instantiate(Classic,sp2.transform.position,Quaternion.identity);
        else if (P2 == 2)
            Instantiate(Bouncy,sp2.transform.position,Quaternion.identity);
        else
            Instantiate(Light,sp2.transform.position,Quaternion.identity);
